    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                {this.state.detected ? (<div className='px-6 py-4 bg-green-300 text-green-600 w-full sm:w-1/6 text-center mx-auto rounded-xl'>Found You!</div>) : (
                    <div className='px-6 py-4 bg-red-300 text-red-600 w-full sm:w-1/2 text-center mx-auto rounded-xl'>Show Yourself</div>
                )}
            </div>
        );
    }
